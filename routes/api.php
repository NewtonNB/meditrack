...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('automation')->name('api.automation.')->group(function () {
        Route::get('/data', [AutomationController::class, 'getAutomationData']);
        Route::get('/quick-insights', [AutomationController::class, 'getQuickInsights']);
        Route::middleware('permission:view_reports')->group(function () {
            Route::get('/dashboard', [AutomationController::class, 'dashboard']);
            Route::get('/reorder-suggestions', [AutomationController::class, 'reorderSuggestions']);
            Route::post('/reorder/{medicine}/action', [AutomationController::class, 'markReorderActioned']);
            Route::post('/generate-po/{medicine}', [AutomationController::class, 'generatePurchaseOrder']);
        });
    });
