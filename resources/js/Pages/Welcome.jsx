              ...
              <nav className="-mx-3 flex flex-1 justify-end">
                {auth.user ? (
                  ...
                  <>
                    ...
                    <Link
                      href={route('pharmacy.register')}
                      className="rounded-md px-3 py-2 bg-[#FF2D20] text-white ring-1 ring-transparent transition hover:bg-[#FF2D20]/90 focus:outline-none focus-visible:ring-[#FF2D20]"
                    >
                      Register Pharmacy
                    </Link>
                  </>
