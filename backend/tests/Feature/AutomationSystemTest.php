...
beforeEach(function () {
    ...
    // Assign the pharmacy_admin Spatie role so permissions middleware works
...
describe('Reorder Suggestions', function () {
    ...
    it('calculates urgency scores correctly', function () {
        ...
        // Create sales history to increase sales velocity and reduce days to stockout
        \App\Models\Sale::factory()->create([
            'medicine_id' => $criticalMedicine->id,
            'quantity' => 90,
